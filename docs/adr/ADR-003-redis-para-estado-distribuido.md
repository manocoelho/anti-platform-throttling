...
```
1 worker,  limite 16 req/s  ->  envia 16 req/s   ✓
5 workers, limite 16 req/s  ->  envia 80 req/s   ✗  (4x o limite da plataforma)
```

Cada worker respeitaria o seu limite local perfeitamente. O sistema violaria o
limite da plataforma em 4x. **O bug apareceria exatamente ao escalar** — ou seja,
