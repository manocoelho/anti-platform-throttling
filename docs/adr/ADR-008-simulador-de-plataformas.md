...
`16 < 20` — aritmética, não engenharia.
...
precisamente por isso que a **margem de segurança de 20%** existe — e o teste é o
que verifica se ela é suficiente.
...
|---|---|---|---|
| YouTube | 20 req/s | 16 req/s | 20% |
| Instagram | 10 req/s | 8 req/s | 20% |

Não são números oficiais — as plataformas não os publicam, e eles mudam sem aviso.
Os valores foram calibrados para dois objetivos didáticos: limites **assimétricos**,
para que o bulkhead tenha plataformas de perfis diferentes para isolar; e limites
**baixos**, para que um teste de carga complete em segundos.
